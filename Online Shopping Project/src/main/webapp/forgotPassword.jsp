			...
			<form action="forgotPasswordAction.jsp" method="post">
				...
				<input type="number" name="phone" placeholder="Enter Phone Number"	required>
				 <select name="securityQuestion">
					...
					<option value="What Elementry school you attend?">What is
						the name of your pet?</option>
					<option value="What is the name of your town where you were born?">What
						is the name of your town where you were born?</option>
				</select> 
